                ...
                <div class="card-body">
                    <form @submit.prevent="submitUpdate">
                        <div>
                            ...
                            <h2 class="text-dark mb-4 text-bold">Audio စာစဉ်အား ပြင်ဆင်ရန်</h2>
                            <hr class="mx-n3">
                        ...
                        <div class="row align-items-center pt-4 pb-3">
                            <div class="col-md-3 ps-5">
                                ...
                                <h6 class="mb-0">Audio စာစဉ်ခေါင်းစဉ်</h6>
                        ...
                        <div class="row align-items-center pt-4 pb-3">
                            <div class="col-md-3 ps-5">
                                ...
                                <h6 class="mb-0">စာဖတ်သူ</h6>

                            </div>
                            <div class="col-md-9 pe-5">

                                <input v-model="editData.voices" type="text" class="form-control form-control-lg" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="detail">
                                    ...
                                    <div v-if="post.voices !== null" class="row col-12  m-1 p-1">
                                        <span class="col-4 p-1">စာဖတ်သူ</span> <span class="col-6 p-1">: {{
                                            post.voices }}</span>
                                    </div>
                                    ...
                                    <div v-if="post.origin_author !== null" class="row m-1 p-1">
                                        <span class="col-4 p-1">စာစဉ်မူရင်းရေးသူ</span> <span class="col-6 p-1">: {{
                                ...
                                <div>
                                    <v-list>
                                        <v-list-item v-for="chapter in chapterList" :key="chapter.id" class="list-item"
                                            @click="this.$router.push({ name: 'AEpisodeDetail', params: { id: chapter.id } })">
                                            <v-list-item-content>
...
export default {
    ...
    methods: {
        async submitUpdate() {
            ...
            console.log("categories", this.editCategoryName)
            console.log("tags", this.editTags)
            formData.append('title', this.editData.title)
            formData.append('voices', this.editData.voices)

            if (this.$refs.imageInput.files[0] !== undefined) {
            ...
            await axios.put(`audios/edit/${pk}/`, formData, { headers: { 'Content-Type': 'multipart/form-data ', 'Authorization': `Bearer ${this.$store.state.token}` } }).then((result) => {
        ...
        editModeOn() {
            ...
            for (const tag in this.editData.tags) {

                this.editTags.push(tag.id)
            }
            console.log("edit mode category", this.editCategoryName)
            console.log("edit mode tags", this.editTags)
        },
        editModeOff() {
            this.isEdit = false
            this.editData = {}
        ...
        GetPostDetail() {
            ...
            axios.get(`audios/detail/${id}/`).then((result) => {
                this.post = result.data["data"]
                console.log('audio post', this.post)
                this.isLoad = false
        ...
        getChapters() {
            const id = this.$route.params.id
            axios.get(`audios/${id}/chapters/`).then((res) => {
        ...
        createChapter() {
            const id = this.$route.params.id
            this.$router.push({ name: 'AEpisodeCreate', params: { id: id } });
        },
        getCurrentUser() {
        ...
        getCategories() {
            axios.get('audios/categories/').then((result) => {
        ...
        getTagsList() {
            axios.get('audios/tag/').then((result) => {
        ...
        addNewTag() {
            axios.post('audios/tag/', { "tag": this.newTag }).then((res) => {
                this.getTagsList();
