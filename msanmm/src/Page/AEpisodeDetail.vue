            ...
            <div v-show="isLoad" class="mt-5">
                <div class="container crumbs my-2">
                    <div class="container p-2 m-2">
                        ...
                        <router-link :to="{ name: 'AudioDetail', params: { id: postId } }"><span><v-icon
                ...
                <v-card v-if="!isEdit" class="container" max-width="1000">
                    ...
                    <div class="container m-4">
                        <v-btn v-if="prevChapter > 0"
                            @click="this.$router.push({ name: 'ChapterDetailPage', params: { id: prevChapter } })"
                        ...
                        <v-btn v-if="nextChapter > 0"
                            @click="this.$router.push({ name: 'ChapterDetailPage', params: { id: nextChapter } })"
                    ...
                    <v-card-text class="m-3 text-justify ">

                        <iframe class="youtube-layout" :src="result" frameborder="0"
                    ...
                    <v-form @submit.prevent="updateChapter">
                        <v-container>
                            <v-row>
                                ...
                                <v-col cols="12" md="8">
                                    <v-text-field single-line density="compact" class="scrollable-textarea"
                                        :rules="bodyRules" label="အသံဖိုင် link " v-model="editData.body"
...
export default {
    ...
    methods: {
        loadURL() {
            ...
            console.log("your url ", this.chapter.audio_url)
            console.log("your url", this.youtubeURL)
            ...
            this.youtubeURL = "";
            console.log("youtube url", this.result)
        },
        toggleSizing() {
        ...
        getPrevChapter() {
            ...
            axios.get(`audios/${id}/prev/`).then((result) => {
        ...
        getNextChapter() {
            ...
            axios.get(`audios/${id}/next/`).then((result) => {
        ...
        async updateChapter() {
            ...
            await axios.put(`audios/chapter/edit/${pk}/`, formData, { headers: { 'Content-Type': 'multipart/form-data ' } }).then((result) => {
