                                ...
                                <div class="card-body">
                                    <form @submit.prevent="submitCreate">
                                        <div>
                                            ...
                                            <h2 class="text-dark mb-4 text-bold">Audio ဖိုင် အသစ်တင်ရန်</h2>
                                            <hr class="mx-n3">
                                        ...
                                        <div class="row align-items-center pt-4 pb-3">
                                            <div class="col-md-3 ps-5">
                                                ...
                                                <h6 class="mb-0">အသံစာစဉ် ခေါင်းစဉ်</h6>
                                        ...
                                        <div class="row align-items-center pt-4 pb-3">
                                            ...
                                            <div class="col-md-2 ps-3">
                                                ...
                                                <h6 class="mb-0">စာစဉ်မူရင်းရေးသားသူ</h6>
...
export default {
    ...
    methods: {
        async submitCreate() {
            ...
            formData.append('voices', this.translator)
